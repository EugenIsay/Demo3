...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("database=isajkin; Username=isajkin; Host=45.67.56.214; Port=5454; Password=hqD9f9EZ");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Client>(entity =>
        {
            ...
            entity.ToTable("client", "task-19-09");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.Clients)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("tagofclient", "task-19-09");
        ...
        modelBuilder.Entity<Clientservice>(entity =>
        {
            ...
            entity.ToTable("clientservice", "task-19-09");
        ...
        modelBuilder.Entity<Documentbyservice>(entity =>
        {
            ...
            entity.ToTable("documentbyservice", "task-19-09");
        ...
        modelBuilder.Entity<Gender>(entity =>
        {
            ...
            entity.ToTable("gender", "task-19-09");
        ...
        modelBuilder.Entity<Manufacturer>(entity =>
        {
            ...
            entity.ToTable("manufacturer", "task-19-09");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.ToTable("product", "task-19-09");
            ...
            entity.HasMany(d => d.Attachedproducts).WithMany(p => p.Mainproducts)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("attachedproduct", "task-19-09");
        ...
        modelBuilder.Entity<Productphoto>(entity =>
        {
            ...
            entity.ToTable("productphoto", "task-19-09");
        ...
        modelBuilder.Entity<Productsale>(entity =>
        {
            ...
            entity.ToTable("productsale", "task-19-09");
        ...
        modelBuilder.Entity<Service>(entity =>
        {
            ...
            entity.ToTable("service", "task-19-09");
        ...
        modelBuilder.Entity<Servicephoto>(entity =>
        {
            ...
            entity.ToTable("servicephoto", "task-19-09");
